...
// Helper to parse the raw body as JSON (Vercel doesn't always auto-parse)
function parseBody(req) {
  return new Promise((resolve, reject) => {
    // Already parsed by Vercel's built-in body parser
...
module.exports = async (req, res) => {
  ...
  // Add selected addon subscriptions at the same quantity
